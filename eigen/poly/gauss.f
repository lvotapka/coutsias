...
c        kind = 7:  gegenbauer quadrature (UNDER CONSTRUCTION)
c
...
c
   ...
   61    b(i) = dsqrt(i*(i + alpha))
      a(n) = 2.0d0*n - 1 + alpha
      return
c              kind = 7:  gegenbauer polynomials (UNDER CONSTRUCTION)
   70 write(*,*) 'YOU HAVE NOT IMPLEMENTED THIS CASE YET YOU LAZY BUM!'
      stop
      end
C-----------------------------------------------------------------------
