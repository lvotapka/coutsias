...
c
      ...
      integer n, i1mach, nmin, nmax, nsum, ny
...
c may 1980 edition.   w. fullerton, c3, los alamos scientific lab.
      implicit none
      integer nterms, initds, n, n16, ndx
...
c
      implicit none
      integer npart, ibase, i1mach, i, ipart
      real r1mach, amin1
...
c june 1977 edition.   w. fullerton, c3, los alamos scientific lab.
      implicit none 
      integer nterms, initds, n, ntrval
...
c june 1977 edition.   w. fullerton, c3, los alamos scientific lab.
      implicit none
      integer niter, iter, n, irem, ixpnt
      real alog, z
...
c
      implicit none
      integer messg(nw)
      integer nw, nerr, nwp, nerrp, i, iwunit, i8save, i1mach 
      logical save
